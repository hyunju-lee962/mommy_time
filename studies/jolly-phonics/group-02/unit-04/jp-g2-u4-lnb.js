...
function injectLNBStyle() {
  ...
  style.textContent = `
    ...
    #unitLNB {
      ...
      background: #FEFCFF;
      border-right: 2px solid #38B2AC66;
      overflow-y: auto;
      z-index: 150;
      padding: 16px 0 32px;
    ...
    .lnb-unit-title {
      font-size: 16px; font-weight: 800; color: #1a8a84;
    }
    .lnb-progress {
      margin-top: 8px;
    }
    ...
    .lnb-prog-fill {
      height: 100%; background: #1a8a84; border-radius: 6px; transition: width .4s;
    }
    .lnb-prog-txt {
    ...
    .lnb-item:hover {
      background: #E6FFFAdd; border-left-color: #38B2AC88;
    }
    .lnb-item.active {
      background: #E6FFFA;
      border-left-color: #1a8a84;
      color: #1a8a84;
      font-weight: 800;
    }
    .lnb-item.done {
    ...
    .lnb-num {
      ...
      background: #E6FFFA; color: #1a8a84;
      display: flex; align-items: center; justify-content: center;
      font-size: 11px; font-weight: 800; flex-shrink: 0;
      transition: all .15s;
    }
    .lnb-item.active .lnb-num {
      background: #1a8a84; color: #fff;
    }
...
function buildLNB() {
  ...
  lnb.innerHTML = `
    <div class="lnb-header">
      <div class="lnb-unit-label">Group 2 · Unit 4</div>
      <div class="lnb-unit-title">br, cr, dr, fr, gr, pr, tr</div>
