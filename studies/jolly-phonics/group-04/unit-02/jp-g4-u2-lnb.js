...
function injectLNBStyle() {
  ...
  style.textContent = `
    ...
    #unitLNB {
      ...
      background: #FEFCFF;
      border-right: 2px solid #F4845F66;
      overflow-y: auto;
      z-index: 150;
      padding: 16px 0 32px;
    ...
    .lnb-unit-title {
      font-size: 16px; font-weight: 800; color: #8B3000;
    }
    .lnb-progress {
      margin-top: 8px;
    }
    ...
    .lnb-prog-fill {
      height: 100%; background: #8B3000; border-radius: 6px; transition: width .4s;
    }
    .lnb-prog-txt {
    ...
    .lnb-item:hover {
      background: #FFF0EBdd; border-left-color: #F4845F88;
    }
    .lnb-item.active {
      background: #FFF0EB;
      border-left-color: #8B3000;
      color: #8B3000;
      font-weight: 800;
    }
    .lnb-item.done {
    ...
    .lnb-num {
      ...
      background: #FFF0EB; color: #8B3000;
      display: flex; align-items: center; justify-content: center;
      font-size: 11px; font-weight: 800; flex-shrink: 0;
      transition: all .15s;
    }
    .lnb-item.active .lnb-num {
      background: #8B3000; color: #fff;
    }
...
function buildLNB() {
  ...
  lnb.innerHTML = `
    <div class="lnb-header">
      <div class="lnb-unit-label">Group 4 · Unit 2</div>
      <div class="lnb-unit-title">er, ir, ur (bird, her, burn)</div>
