...
function injectLNBStyle() {
  ...
  style.textContent = `
    ...
    #unitLNB {
      ...
      background: #FEFCFF;
      border-right: 2px solid #E8737A66;
      overflow-y: auto;
      z-index: 150;
      padding: 16px 0 32px;
    ...
    .lnb-unit-title {
      font-size: 16px; font-weight: 800; color: #9B2028;
    }
    .lnb-progress {
      margin-top: 8px;
    }
    ...
    .lnb-prog-fill {
      height: 100%; background: #9B2028; border-radius: 6px; transition: width .4s;
    }
    .lnb-prog-txt {
    ...
    .lnb-item:hover {
      background: #FFF0F0dd; border-left-color: #E8737A88;
    }
    .lnb-item.active {
      background: #FFF0F0;
      border-left-color: #9B2028;
      color: #9B2028;
      font-weight: 800;
    }
    .lnb-item.done {
    ...
    .lnb-num {
      ...
      background: #FFF0F0; color: #9B2028;
      display: flex; align-items: center; justify-content: center;
      font-size: 11px; font-weight: 800; flex-shrink: 0;
      transition: all .15s;
    }
    .lnb-item.active .lnb-num {
      background: #9B2028; color: #fff;
    }
...
function buildLNB() {
  ...
  lnb.innerHTML = `
    <div class="lnb-header">
      <div class="lnb-unit-label">Group 7 · Unit 3</div>
      <div class="lnb-unit-title">Silent letters (lamb, wrap, gnome)</div>
