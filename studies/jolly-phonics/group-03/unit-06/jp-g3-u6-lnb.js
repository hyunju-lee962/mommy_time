...
function injectLNBStyle() {
  ...
  style.textContent = `
    ...
    #unitLNB {
      ...
      background: #FEFCFF;
      border-right: 2px solid #9B72CF66;
      overflow-y: auto;
      z-index: 150;
      padding: 16px 0 32px;
    ...
    .lnb-unit-title {
      font-size: 16px; font-weight: 800; color: #5A28A0;
    }
    .lnb-progress {
      margin-top: 8px;
    }
    ...
    .lnb-prog-fill {
      height: 100%; background: #5A28A0; border-radius: 6px; transition: width .4s;
    }
    .lnb-prog-txt {
    ...
    .lnb-item:hover {
      background: #F3EEFFdd; border-left-color: #9B72CF88;
    }
    .lnb-item.active {
      background: #F3EEFF;
      border-left-color: #5A28A0;
      color: #5A28A0;
      font-weight: 800;
    }
    .lnb-item.done {
    ...
    .lnb-num {
      ...
      background: #F3EEFF; color: #5A28A0;
...
function buildLNB() {
  ...
  lnb.innerHTML = `
    <div class="lnb-header">
      <div class="lnb-unit-label">Group 3 · Unit 6</div>
      <div class="lnb-unit-title">Review — Group 3</div>
