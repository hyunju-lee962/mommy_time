...
function injectLNBStyle() {
  ...
  style.textContent = `
    ...
    #unitLNB {
      ...
      background: #FEFCFF;
      border-right: 2px solid #52B78866;
      overflow-y: auto;
      z-index: 150;
      padding: 16px 0 32px;
    ...
    .lnb-unit-title {
      font-size: 16px; font-weight: 800; color: #1a5c3a;
    }
    .lnb-progress {
      margin-top: 8px;
    }
    ...
    .lnb-prog-fill {
      height: 100%; background: #1a5c3a; border-radius: 6px; transition: width .4s;
    }
    .lnb-prog-txt {
    ...
    .lnb-item:hover {
      background: #E8F8EFdd; border-left-color: #52B78888;
    }
    .lnb-item.active {
      background: #E8F8EF;
    ...
    .lnb-num {
      ...
      background: #E8F8EF; color: #1a5c3a;
...
function buildLNB() {
  ...
  lnb.innerHTML = `
    <div class="lnb-header">
      <div class="lnb-unit-label">Group 5 · Unit 4</div>
      <div class="lnb-unit-title">tion, sion (station, television)</div>
